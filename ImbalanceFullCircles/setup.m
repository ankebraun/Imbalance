...
options.dist = 75; %65; %75; % viewing distance in cm 
...
options.ringwidth = deg2pix(options, 0.75)*scaling_factor;
...
options.radius = deg2pix(options, 1.3)*scaling_factor;
...
%options.beeps = {repmat(audioread('low_mrk_150Hz.wav'), 1,2)', repmat(audioread('high_mrk_350Hz.wav'), 1,2)', repmat(audioread('whitenoise250.wav'), 1,2)'};
